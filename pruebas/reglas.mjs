...
await debeAndar('A elige el máximo permitido', () => set(ref(A.db, `${P}/config/rondas`), 15))
await debeFallar('A se pasa del máximo de rondas', () => set(ref(A.db, `${P}/config/rondas`), 20))
await debeFallar('A pide cero rondas', () => set(ref(A.db, `${P}/config/rondas`), 0))
await debeFallar('A pide media ronda', () => set(ref(A.db, `${P}/config/rondas`), 2.5))
